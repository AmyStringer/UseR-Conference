...
\begin{frame}
  Notes from audience
  \begin{itemize}
    \item Add in some defensive programming - what is users enter in an invalid country, at this stage they would get a data base error for for a non R user this is not particularly informative. This also makes way to funny error messages, funny error messages rule
    \item There was a comment about because able to run the short for loop script through terminal and negate the need for even opening R or any of the associated scripts. This is definitely possible and I'm sad I hadn't considered it earlier
    \item 
  \end{itemize}
\end{frame}
